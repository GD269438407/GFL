...
if __name__ == "__main__":
    ...
    # create folds
    cold_target_fold = create_fold_setting_cold(df, args.SEED, [0.9, 0.09,0.01], ['target_key'])
    cold_target_fold["train"].to_csv("../Data/" + args.dataset_name + "_train_all_"+str(args.SEED)+".csv", index=False)
    cold_target_fold["valid"].to_csv("../Data/" + args.dataset_name + "_val_all_"+str(args.SEED)+".csv", index=False)
