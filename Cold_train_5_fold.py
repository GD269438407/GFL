...
for scene in ['drug']:
    for i in [1,2,3,4,42,6,7,8,9,10]:
        o=i
        i=str(i)
        ...
        load_model_path = 'pretrain_model_cold_'+scene+'_'+i+'.model'
        model_file_name = 'model_davis_NHGNN_iMOLD_cold_'+scene+'_codebook_num_12000_3_'+i+'.model'
        result_file_name = 'result_davis_NHGNN_iMOLD_cold_'+scene+'_codebook_num_12000_3_'+i+'.csv'
        result_file_name_1 =  'result_davis_NHGNN_iMOLD_cold_'+scene+'_codebook_num_12000_3_withname'+i+'.csv'
        print('creat dataset...')
        ...
        dataset_train = DTADataset(root='../Data/' + dataset_name, path='../Data/' +  'davis_cold_'+scene+'_train_'+i+'.csv', smiles_emb=smiles_emb,
                             target_emb=target_emb, smiles_idx=smiles_idx, smiles_graph=smiles_graph, target_graph=target_graph,
                             smiles_len=smiles_len, target_len=target_len)

        dataset_test = DTADataset(root='../Data/' + dataset_name, path='../Data/' +  'davis_cold_'+scene+'_test_'+i+'.csv', smiles_emb=smiles_emb,
                             target_emb=target_emb, smiles_idx=smiles_idx, smiles_graph=smiles_graph, target_graph=target_graph,
                             smiles_len=smiles_len, target_len=target_len)

        dataset_valid = DTADataset(root='../Data/' + dataset_name, path='../Data/' +  'davis_cold_'+scene+'_valid_'+i+'.csv', smiles_emb=smiles_emb,
                             target_emb=target_emb, smiles_idx=smiles_idx, smiles_graph=smiles_graph, target_graph=target_graph,
                             smiles_len=smiles_len, target_len=target_len)
